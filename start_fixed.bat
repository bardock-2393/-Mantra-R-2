@echo off
REM AI Video Detective - Fixed Startup Script for Windows
REM This script fixes Ray cluster issues and starts the application properly
...
REM Set environment variables for better resource management
set RAY_NUM_CPUS=4
set RAY_NUM_GPUS=1
set RAY_OBJECT_STORE_MEMORY=500000000
set ENV=development
set DEBUG=true
set IS_REMOTE_SERVER=false
